...
if __name__ == '__main__':
    ...
    train_path = "E:/ljwgroupSRTP/unet-master/CamVid"
    image_folder = "train"
    label_folder = "trainannot"
    valid_path =  "E:/ljwgroupSRTP/unet-master/CamVid"
    valid_image_folder ="val"
    valid_label_folder = "valannot"
    log_filepath = 'E:/ljwgroupSRTP/unet-master/log'
    ...
    model = load_model("E:/ljwgroupSRTP/unet-master/model/CamVid_model_v1.hdf5")

    tb_cb = TensorBoard(log_dir=log_filepath)
    model_checkpoint = keras.callbacks.ModelCheckpoint('E:/ljwgroupSRTP/unet-master/model/CamVid_model_v1.hdf5', monitor='val_loss',verbose=1,save_best_only=True)
