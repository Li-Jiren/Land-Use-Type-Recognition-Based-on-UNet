...
if __name__ == '__main__':
    ...
    test_path = "E:/ljwgroupSRTP/unet-master/json/test"

    # save the predict images
    save_path = "E:/ljwgroupSRTP/unet-master/json/predict"

    dp = data_preprocess(test_path=test_path,save_path=save_path,flag_multi_class=True,num_classes=13)

    #load model
    model = load_model('E:/ljwgroupSRTP/unet-master/model/json_model_v1.hdf5')
