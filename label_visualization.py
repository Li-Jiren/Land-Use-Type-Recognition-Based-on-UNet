...
test_path = "C:/作业/SRTP/ljwgroupSRTP/unet-master/json/test1"
predict_path =  "C:/作业/SRTP/ljwgroupSRTP/unet-master/json/predict1"
for filename in os.listdir(test_path):
    imgfile = os.path.join(test_path,filename)
    pngfile = os.path.join(predict_path,filename.split('.')[0]+"_predict.png")
    img = cv2.imdecode(np.fromfile(img, dtype=np.uint8))　　
