...
if __name__ == '__main__':
    ...
    train_path = "E:/ljwgroupSRTP/unet-master/json"
    image_folder = "train"
    label_folder = "trainannot"
    valid_path =  "E:/ljwgroupSRTP/unet-master/json"
    valid_image_folder ="val"
    valid_label_folder = "valannot"
    log_filepath = 'E:/ljwgroupSRTP/unet-master/json/log'
    ...
    model_checkpoint = keras.callbacks.ModelCheckpoint('E:/ljwgroupSRTP/unet-master/model/json_model_v1.hdf5', monitor='val_loss',verbose=1,save_best_only=True)
